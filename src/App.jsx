...
function generateWeeklyReportPdf({ clientName, weekDates, macroData, workoutData, profileData, comment }) {
  ...
  doc.setFontSize(18);
  doc.text("SW FITNESS — Weekly Report", 14, y);
  y += 9;
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", padding: 24 }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <svg width="70" height="30" viewBox="0 0 138 60" style={{ marginBottom: 10 }}>
            <rect x="0" y="0" width="18" height="60" rx="4" fill={COLORS.plate} />
            <rect x="24" y="10" width="14" height="40" rx="3" fill={COLORS.plate} />
            <rect x="12" y="23" width="110" height="14" rx="7" fill={COLORS.chalk} />
            <rect x="96" y="10" width="14" height="40" rx="3" fill={COLORS.plate} />
            <rect x="120" y="0" width="18" height="60" rx="4" fill={COLORS.plate} />
          </svg>
